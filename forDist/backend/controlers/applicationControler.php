...
class ApplictionControler
{
    ...
    function updateProductList($data)
    {
        ...
        $result = $this->connect->query($sql, 'result');
    ...
    public function addApp($data)
    {
        ...
        $link = $this->connect->query($sql);
        $data["id"] = $link->insert_id;
        $this->connect->query("INSERT INTO `order_history` (`id_status`, `id_order`,id_user) VALUES ('" . $data['status'] . "', '" . $data["id"] . "', $id_user)");
    }
}
